...
public class ElasticityComponentInfo {
    ...
    public   Double  sourceCPUUsage=0.0;
    public   Double  sourceMemoryUsage=0.0;
    public   Double  targetWorkerNoneCpuLoad=0.0;
    public   Double  sourceWorkerNoneCpuLoad=0.0;
    public   Long    InputRateTopology=0L;
...
//        }};
    ...
    public Long getInputRateTopolgy() {
        return InputRateTopology;
    }
    ...
    public Double getSourceCPUUsage() {
        return sourceCPUUsage;
    }


    public Double getSourceMemoryUsage() {
        return sourceMemoryUsage;
    }
...
/////////////////////////////////////////////
    ...
    public  Double  setSourceCPUUsage( Double sourceCPUUsage ) {
        return this.sourceCPUUsage =sourceCPUUsage;
    }


    public  Double  setSourceMemoryUsage( Double sourceMemoryUsage ) {
        return this.sourceMemoryUsage =sourceMemoryUsage;
    }
    ...
    public  Long  setInputRateTopology( Long inputRateTopology ) {
        return this.InputRateTopology =inputRateTopology;
    }
