...
//import static org.apache.storm.daemon.ui.UIHelpers.getWindowHint;
//import static org.apache.storm.daemon.ui.UIHelpers.unpackSpoutPageInfo;
...
//        Double totalMem =0.0;
    ...
    public HashSet<String> getComponentsNameCPUInformation(Nimbus.Iface client, String topology) throws Exception {
        ...
        for (TopologySummary ts : clusterSummary.get_topologies()) {
            ...
            //System.out.println(".......topology ..." + topology + ".......ts ..." + ts.get_name());
        ...
        if (topologySummary == null) {
            ...
            for (ExecutorSummary es : info.get_executors()) {
                ...
                if (  es.get_stats().get_specific().is_set_bolt()) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static  Long getTopologyInputRate(Nimbus.Iface client, String topology) throws Exception {
        HashSet<String> components = new HashSet<>();
        Long topologyInputRate =0L; ;
        ClusterSummary clusterSummary = client.getClusterInfo();
        TopologySummary topologySummary = null;
        for (TopologySummary ts : clusterSummary.get_topologies()) {
        ...
        if (topologySummary == null) {
            ...
            for (ExecutorSummary es : info.get_executors()) {
                ...
                {
                    //completeTime = es.get_stats().get_specific().get_spout().get_failed() ;
                    Double rate = es.get_stats().get_rate();
                    Map<String, Map<String, Long>> emitted  = es.get_stats().get_emitted() ;
                    for (Entry  <String, Map<String, Long>>  entry : emitted.entrySet()) {
                        String caption = entry.getKey();
                       // System.out.println(".....getTopologyInputRate.....caption........" + caption);
                        Map<String, Long> info2 = entry.getValue();
                        for (Entry<String, Long> entry2 : info2.entrySet()) {
                            String stream = entry2.getKey();
                          //  System.out.println("....getTopologyInputRate......stream........" + stream);
                            Long value = entry2.getValue();
                           // System.out.println("....getTopologyInputRate..caption.. stream..value........" +caption +"..."+stream +"..."+ value);

                            if (caption.equals(":all-time") && stream.equals("default"))
                            {
                                topologyInputRate = value;
                               // System.out.println("....getTopologyInputRate..selected........"+ value);
                            }
    ...
    public static  Map<String, Map<String, Long>> getTopologyFailedNumber(Nimbus.Iface client, String topology) throws Exception {
        HashSet<String> components = new HashSet<>();
        Map<String, Map<String, Long>> completeTime = new HashMap<>();
        ClusterSummary clusterSummary = client.getClusterInfo();
        TopologySummary topologySummary = null;
        for (TopologySummary ts : clusterSummary.get_topologies()) {
            if (topology.equals(ts.get_id())) {
        ...
        if (topologySummary == null) {
            ...
            for (ExecutorSummary es : info.get_executors()) {
                if (  es.get_stats().get_specific().is_set_spout())
                {
                   ...
                   //  System.out.println(".......getTopologyFailedNumber ......rate:.." + rate);
                   // System.out.println(".......getTopologyFailedNumber ......emitted:.." + emitted);
        ...
        if (topologySummary == null) {
            ...
            for (ExecutorSummary es : info.get_executors()) {
              if (  es.get_stats().get_specific().is_set_spout())
              {
                 ...
                 // System.out.println(".......getTopologyExecuteCompleteTime ......es:.." + es.toString());
                  completeTime = es.get_stats().get_specific().get_spout().get_complete_ms_avg() ;
                  //es.get_stats().get_specific().get_spout().getf
                  //get_failed()

//                  int startTaskExecuters = es.get_executor_info().get_task_start() ;
//                  es.get_executor_info().get_task_start();
//                  es.get_stats().get_specific().is_set_bolt().



                 // System.out.println(".......getTopologyExecuteCompleteTime ......completeTime:.." + completeTime);
              }
            }
        }
        return completeTime;
    ...
    public HashSet<String> getComponents(Nimbus.Iface client, String topology) throws Exception {
        ...
        for (TopologySummary ts : clusterSummary.get_topologies()) {
            ...
            //System.out.println("....... toplogy..." + topology + "....... toplogy..." + ts.get_name());
            if (topology.equals(ts.get_name())) {
                topologySummary = ts;
                //ts.port
                break;
                                ...
                                // System.out.println(":::::::::::::::Monitorscheduling::result::::::::::::: +" +component +"::::::" + result.toString()   );
                                 ...
                                 if ( capacity != null || executeAverageLatency!= null )
                                 {
                                    ...
                                    if (!topologyID.startsWith("BenchMarkTask") )
                                    {
                                      ...
                                      // System.out.println("............Monitor................... "+topologyID+"::"+ component+ "::"+executeAverageLatency+"::"+capacity);
