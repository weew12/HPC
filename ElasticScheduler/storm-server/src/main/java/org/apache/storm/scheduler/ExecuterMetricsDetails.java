...
public class ExecuterMetricsDetails  {
    ...
    public   Double componentCPUUsage=0.0;
    public   Double componentMemoryUsage=0.0;
   ...
   // public List<String> executers=null;
    ...
    public static Comparator<ExecuterMetricsDetails> CPUUsageComparator = new Comparator<ExecuterMetricsDetails>() {

        public int compare(ExecuterMetricsDetails o1, ExecuterMetricsDetails o2) {

            return Double.compare(o1.getComponentCPUUsage(), o2.getComponentCPUUsage());
    ...
    public Double getComponentCPUUsage() {
        return componentCPUUsage;
    }


    public Double getComponentMemoryUsage() {
...
/////////////////////////////////////////////
    ...
    public  void setComponentCPUUsage( Double componentcpuusage ) {
        this.componentCPUUsage =componentcpuusage;
    }

    public  void setComponentMemoryUsage( Double componentMemoryUsage ) {
        this.componentMemoryUsage =componentMemoryUsage;
    }
